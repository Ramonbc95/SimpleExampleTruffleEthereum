...
contract Votacion {
  ...
  function candidatosVotos(bytes32[] memory nombreCandidatos) public { 
  ...
  function votosTotales(bytes32 candidato) public view returns (uint8) {
  ...
  function candidatoEsValido(bytes32 candidato) public view returns (bool) {
